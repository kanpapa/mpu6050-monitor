...
| GND | GND | |
| SDA | **D20**(コネクタ表記 "SDA") | ⚠️ 下記の注意参照 |
| SCL | **D21**(コネクタ表記 "SCL") | ⚠️ 下記の注意参照 |
...
- **A4/A5(SDA/SCL)**: I2C3のI2Cバス。今回の構成(デフォルトの`Wire`)では**応答しません**
- **D20/D21(コネクタ表記 "SDA"/"SCL"、数字なし)**: I2C2のI2Cバス。デフォルトの`Wire`はこちらに対応
